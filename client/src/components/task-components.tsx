...
import taskService, { Question } from '../services/question_service';
          ...
          <Row>
            ...
            <Column>
              <Form.Checkbox checked={this.task.done} onChange={() => {
                  taskService
                    .update({ id: this.task.id, title: this.task.title, description: this.task.description, done: !this.task.done })
